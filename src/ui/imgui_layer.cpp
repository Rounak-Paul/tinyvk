...
void ImGuiLayer::SetupStyle() {
    ...
    colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.06f, 0.06f, 0.06f, 1.00f);
    ...
    // Drag drop
    colors[ImGuiCol_DragDropTarget] = ImVec4(0.40f, 0.40f, 0.40f, 0.90f);
